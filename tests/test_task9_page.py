...
class Task9PageContractTests(unittest.TestCase):
    def test_task9_page_loads_full_dataset_and_trainer_hooks(self):
        ...
        for marker in ('data-task9-prototypes','data-task9-quiz','data-task9-score','data-task9-current-total','data-task9-reset','href="../../index.html#progress"','src="task9.js"','href="task9.css"','/study/vendor/mathjax-3.2.2/es5/tex-mml-chtml.js'):
