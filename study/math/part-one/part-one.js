...
const prototypeData = {
  "6.1": { title: "сложение десятичных дробей", items: [["6.1.1","6,8 + 2,6","9,4"],["6.1.2","6,9 + 7,4","14,3"],["6.1.3","7,9 + 2,2","10,1"],["6.1.4","8,3 + 5,4","13,7"],["6.1.5","8,4 + 3,7","12,1"],["6.1.6","8,7 + 4,6","13,3"],["6.1.7","8,8 + 5,9","14,7"],["6.1.8","9,3 + 7,8","17,1"],["6.1.9","9,8 + 8,6","18,4"]] },
  "6.2": { title: "вычитание десятичных дробей", items: [["6.2.1","4,9 - 9,4","-4,5"],["6.2.2","3,6 - 4,1","-0,5"],["6.2.3","3,9 - 7,3","-3,4"],["6.2.4","4,4 - 1,7","2,7"],["6.2.5","4,7 - 8,2","-3,5"],["6.2.6","5,7 - 7,6","-1,9"],["6.2.7","6,1 - 2,5","3,6"],["6.2.8","6,4 - 4,8","1,6"],["6.2.9","9,2 - 2,4","6,8"]] },
  "6.3": { title: "умножение десятичных дробей", items: [["6.3.1","2,1 * 9,6","20,16"],["6.3.2","2,3 * 7,5","17,25"],["6.3.3","3,2 * 6,2","19,84"],["6.3.4","5,2 * 3,1","16,12"],["6.3.5","6,7 * 5,5","36,85"],["6.3.6","7,7 * 5,3","40,81"],["6.3.7","8,1 * 7,2","58,32"],["6.3.8","8,9 * 4,3","38,27"],["6.3.9","9,9 * 7,1","70,29"]] },
  "6.4": { title: "деление десятичных дробей", items: [["6.4.1","4,8 : 0,4","12"],["6.4.2","8,4 : 1,2","7"],["6.4.3","6,8 : 1,7","4"],["6.4.4","8,7 : 2,9","3"],["6.4.5","8,2 : 4,1","2"],["6.4.6","9,6 : 1,2","8"],["6.4.7","13,2 : 1,2","11"],["6.4.8","8,1 : 0,9","9"],["6.4.9","6,5 : 1,3","5"]] },
  "6.5": { title: "сложение обыкновенных дробей", items: [["6.5.1","1/2 + 31/20","2,05"],["6.5.2","1/2 + 33/50","1,16"],["6.5.3","1/4 + 37/20","2,1"],["6.5.4","1/5 + 17/10","1,9"],["6.5.5","1/5 + 19/20","1,15"],["6.5.6","1/5 + 53/50","1,26"],["6.5.7","1/10 + 29/20","1,55"],["6.5.8","1/10 + 21/50","0,52"],["6.5.9","1/25 + 43/50","0,9"]] },
  "6.6": { title: "вычитание обыкновенных дробей", items: [["6.6.1","1/2 - 49/20","-1,95"],["6.6.2","1/2 - 13/50","0,24"],["6.6.3","1/4 - 51/20","-2,3"],["6.6.4","1/5 - 47/10","-4,5"],["6.6.5","1/5 - 41/50","-0,62"],["6.6.6","1/5 - 27/20","-1,15"],["6.6.7","1/10 - 39/50","-0,68"],["6.6.8","1/10 - 23/20","-1,05"],["6.6.9","1/25 - 7/50","-0,1"]] },
  "6.7": { title: "умножение обыкновенных дробей", items: [["6.7.1","5/3 * 9/2","7,5"],["6.7.2","3/4 * 6/5","0,9"],["6.7.3","15/4 * 6/5","4,5"],["6.7.4","2/5 * 9/8","0,45"],["6.7.5","3/5 * 25/4","3,75"],["6.7.6","7/5 * 12/35","0,48"],["6.7.7","9/5 * 2/3","1,2"],["6.7.8","21/5 * 3/7","1,8"],["6.7.9","7/6 * 9/5","2,1"]] },
  "6.8": { title: "деление обыкновенных дробей", items: [["6.8.1","15/4 : 3/7","8,75"],["6.8.2","3/5 : 2/15","4,5"],["6.8.3","3/5 : 4/35","5,25"],["6.8.4","4/5 : 2/7","2,8"],["6.8.5","6/5 : 4/11","3,3"],["6.8.6","12/5 : 15/2","0,32"],["6.8.7","14/5 : 7/2","0,8"],["6.8.8","21/5 : 6/7","4,9"],["6.8.9","7/8 : 5/6","1,05"]] },
  "6.9": { title: "приведение к заданному знаменателю", items: [["6.9.1","1/7 + 3/4 · знаменатель 56","50"],["6.9.2","2/3 - 7/13 · знаменатель 78","10"],["6.9.3","3/4 - 8/11 · знаменатель 88","2"],["6.9.4","5/8 + 1/3 · знаменатель 48","46"],["6.9.5","6/7 - 3/5 · знаменатель 70","18"],["6.9.6","7/9 - 2/5 · знаменатель 90","34"]] },
  "6.10": { title: "DEMO: смешанные числа", items: [["6.10.1","1 1/28 + 1/12","8,4"],["6.10.2","1 1/36 + 1/45","20"],["6.10.3","1 1/21 + 1/28","12"],["6.10.4","1 1/14 - 1/63","18"],["6.10.5","1 1/36 - 1/44","198"],["6.10.6","1 1/35 - 1/60","84"],["6.10.7","1 1/72 - 1/99","264"]] }
};
...
Object.assign(prototypeData, {
  "6.1": { ...prototypeData["6.1"], title: "сложение десятичных дробей" },
  "6.2": { ...prototypeData["6.2"], title: "вычитание десятичных дробей" },
  "6.3": { ...prototypeData["6.3"], title: "умножение десятичных дробей" },
  "6.4": { ...prototypeData["6.4"], title: "деление десятичных дробей" },
  "6.5": { ...prototypeData["6.5"], title: "сложение обыкновенных дробей" },
  "6.6": { ...prototypeData["6.6"], title: "вычитание обыкновенных дробей" },
  "6.7": { ...prototypeData["6.7"], title: "умножение обыкновенных дробей" },
  "6.8": { ...prototypeData["6.8"], title: "деление обыкновенных дробей" },
  "6.9": { ...prototypeData["6.9"], title: "приведение к заданному знаменателю", items: [["6.9.1", "1/7 + 3/4 (знаменатель 56)", "50"], ["6.9.2", "2/3 − 7/13 (знаменатель 78)", "10"], ["6.9.3", "3/4 − 8/11 (знаменатель 88)", "2"], ["6.9.4", "5/8 + 1/3 (знаменатель 48)", "46"], ["6.9.5", "6/7 − 3/5 (знаменатель 70)", "18"], ["6.9.6", "7/9 − 2/5 (знаменатель 90)", "34"]] },
  "6.10": { ...prototypeData["6.10"], title: "смешанные числа" }
});
